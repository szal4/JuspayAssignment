...
var moveSteps = function moveSteps() {
...
var turn15Degclock = function turn15Degclock() {
...
var turn15DegAnticlock = function turn15DegAnticlock() {
  // transform: rotateZ(45deg);
  var doc = document.getElementById("svg");
  if (doc.style.transform == null || doc.style.transform.length == 0) {
    doc.style.transform = 'rotateZ(-15deg)';
...
var pointIn90 = function pointIn90() {
  var doc = document.getElementById("svg");
...
var setOriginalSize = function setOriginalSize() {
  var doc = document.getElementById("svg");
  var width = 95.17898101806641;
  var height = 100.0415603637695;
  if (doc.style.width != null && doc.style.width != 0 && doc.style.width.length != 0) {
...
function Sidebar() {
  var _useContext = (0,react.useContext)(DropContext),
    content = _useContext.content,
    setContent = _useContext.setContent;
  var handleOnDrag = function handleOnDrag(e, name) {
  ...
  var handleOnDrop = function handleOnDrop(e) {
    var contentObj = e.dataTransfer.getData("revercButtonType");
    //console.log(contentObj);
    var arr = _toConsumableArray(content);
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "When space key pressed");
    },
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
  }, "When space key pressed"), /*#__PURE__*/react.createElement("div", {
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "When clicked");
    },
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
  }, "When clicked"), /*#__PURE__*/react.createElement("div", {
    className: "font-bold text-blue-500"
  }, " ", "Motion", " "), /*#__PURE__*/react.createElement("div", {
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Move 10 steps");
    },
    onClick: moveSteps,
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
    ...
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Turn 15 degree clockwise");
    },
    onClick: turn15Degclock,
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Turn 15 degrees clockwise"), /*#__PURE__*/react.createElement("div", {
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Turn 15 degree Anti-clockwise");
    },
    onClick: turn15DegAnticlock,
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Turn 15 degrees Anti-clockwise"), /*#__PURE__*/react.createElement("div", {
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Point in direction 90");
    },
    onClick: pointIn90,
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
    ...
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Go to random position");
    },
    ...
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Change size by -5");
    },
    onClick: changeSize,
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
  }, "change size by -5"), /*#__PURE__*/react.createElement("div", {
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Set size to 100%");
    },
    onClick: setOriginalSize,
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Set size to 100%"), /*#__PURE__*/react.createElement("div", {
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Show");
    },
    onClick: show,
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
    ...
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Hide");
    },
    onClick: hide,
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Hide"), /*#__PURE__*/react.createElement("div", {
    className: "font-bold text-green-500"
  }, " ", "Contol", " "), /*#__PURE__*/react.createElement("div", {
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Wait 2 seconds");
    },
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Wait 2 seconds"), /*#__PURE__*/react.createElement("div", {
    draggable: true,
    onDragStart: function onDragStart(e) {
      return handleOnDrag(e, "Repeat");
    },
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Repeat"));
}
;// CONCATENATED MODULE: ./src/components/MidArea.js
function MidArea_toConsumableArray(arr) { return MidArea_arrayWithoutHoles(arr) || MidArea_iterableToArray(arr) || MidArea_unsupportedIterableToArray(arr) || MidArea_nonIterableSpread(); }
function MidArea_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function MidArea_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return MidArea_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return MidArea_arrayLikeToArray(o, minLen); }
function MidArea_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function MidArea_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return MidArea_arrayLikeToArray(arr); }
function MidArea_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
...
var nameFxn = {
  "Move 10 steps": moveSteps,
  "Turn 15 degree clockwise": turn15Degclock,
  "Turn 15 degree Anti-clockwise": turn15DegAnticlock,
  "Point in direction 90": pointIn90,
  "Go to random position": randomPosition,
  "Change size by -5": changeSize,
  "Set size to 100%": setOriginalSize,
  "Show": show,
  "Hide": hide
};
function MidArea() {
  ...
  var handleOnDrop = function handleOnDrop(e) {
    var contentObj = e.dataTransfer.getData("buttonType");
    setContent([].concat(MidArea_toConsumableArray(content), [contentObj]));
  };
  var handleDragOver = function handleDragOver(e) {
    e.preventDefault();
  };
  ...
  var handleOnDragStartInMid = function handleOnDragStartInMid(e, content) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      draggable: true,
      onDragStart: function onDragStart(e) {
        return handleOnDragStartInMid(e, ele);
      },
...
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || App_unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
...
var DropContext = /*#__PURE__*/(0,react.createContext)();
function App() {
